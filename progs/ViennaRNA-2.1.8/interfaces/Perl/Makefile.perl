...
#     BUILD_REQUIRES => {  }
#     CCFLAGS => q[-D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fstack-protector -fno-strict-aliasing -pipe -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 $(AM_CXXFLAGS) $(CXXFLAGS) -I../../H]
#     CONFIGURE_REQUIRES => {  }
#     LD => q[${CXX}]
#     LIBS => [q[-lm]]
...
CCFLAGS = -D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fstack-protector -fno-strict-aliasing -pipe -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 $(AM_CXXFLAGS) $(CXXFLAGS) -I../../H
OPTIMIZE = -O2 -g
PERLTYPE = 
MPOLLUTE = 
