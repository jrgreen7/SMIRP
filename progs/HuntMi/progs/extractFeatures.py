...
if len(sys.argv) == 3:
  ...
  arff_file = '../data/results/' + positive + '-' + negative + '.arff'

  positive_features = '../data/results/' + positive + '/' + positive + '.all_features'
  negative_features = '../data/results/' + negative + '/' + negative + '.all_features'
...
if len(sys.argv) == 2:
  ...
  arff_file = '../data/results/' + input + '.arff'

  input_features = '../data/results/' + input + '/' + input + '.all_features'
...
os.system('python remove.py ' + arff_file)
os.system(cmd)
